...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/rh.png'); ?>);"></a>
        ...
        <div class="footer">
            <p>
                ...
                </script> All rights reserved | Aplikasi Administrasi RH Electronic</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        </div>
