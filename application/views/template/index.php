...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 5px 10px;">
 ...
 title: 'Apakah anda yakin akan keluar aplikasi ?', type: 'warning' , showCancelButton: true, confirmButtonColor: '#DD6B55' , confirmButtonText: 'Ya, Sign Out!', closeOnConfirm: false }, function(){ window.location.href = '<?= site_url('sign_out'); ?>'; });">Sign Out</a>
                                </div>
                            </li>
                        </ul>
                    </div>
